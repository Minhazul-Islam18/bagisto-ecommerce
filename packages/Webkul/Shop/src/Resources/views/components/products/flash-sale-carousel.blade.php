<v-products-flash-sale-carousel
    src="{{ $src }}"
    title="{{ $title }}"
...
@pushOnce('scripts')
    <script
        ...
        id="v-products-flash-sale-carousel-template"
    >
        <div
        ...
        >
            ...
            >
                <x-shop::products.flash-sale-card
    ...
    <script type="module">
        app.component('v-products-flash-sale-carousel', {
            template: '#v-products-flash-sale-carousel-template',
